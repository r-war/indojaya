 ...
 */
$sStorePath = '';
$dStorageUsage = trim($_SESSION['StorageUsage']);
$dStorageQuota = trim(1024 * 1000);
$dLimit = $dStorageQuota - $dStorageUsage;
...
$config['Thumbnails'] = Array(
		'url' => $sThumbUrl,
		'directory' => resolveUrl($sThumbUrl),
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$_SESSION['CKFinder_UserRole'] = "member";
...
// $config['ResourceType'][] = Array(
		// 'name' => 'Ads',
		// 'url' => $baseUrl . 'ads',
		// 'directory' => $baseDir . 'ads',
		// 'maxSize' => $dMaxSize,
		// 'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,swf',
		// 'deniedExtensions' => '');
