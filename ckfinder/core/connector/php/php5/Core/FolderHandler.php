...
class CKFinder_Connector_Core_FolderHandler
{
    ...
    public function getThumbsServerPath()
    {
        if (is_null($this->_thumbsServerPath)) {
            ...
            $this->_thumbsServerPath = CKFinder_Connector_Utils_FileSystem::combinePaths($_thumbnailsConfig->getDirectory(), strtolower($this->_resourceTypeConfig->getName()));
			...
			//hp add thumbs folder inside parents folder
			$this->_thumbsServerPath .= '_thumbs/';
