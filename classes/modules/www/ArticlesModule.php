...
class ArticlesModule extends AbstractCommonModule
{
  protected $oNews;
  ...
  public function doBuildTemplate()
  {
    ...
    $this->aContext['news_list'] = NewsPeer::getByType('article', $this->doHandleParameter(), null, $this->getPageList(), $oPager, 10);
