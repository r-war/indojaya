...
class NewsModule extends AbstractCommonModule
{
  protected $oNews;
  ...
  public function doBuildTemplate()
  {
    ...
    $this->aContext['news_list'] = NewsPeer::getByType('news', $this->doHandleParameter(), null, $this->getPageList(), $oPager, 10);
