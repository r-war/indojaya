...
abstract class BaseTeam extends BaseObject  implements Persistent {
	...
	public function setIndex($v)
	{
		...
		if ($this->index !== $v) {
			$this->index = $v;
			$this->modifiedColumns[] = TeamPeer::INDEX;
		}
	...
	public function setShortDescription($v)
	{
		...
		if ($this->short_description !== $v) {
			...
			$this->modifiedColumns[] = TeamPeer::SHORT_DESCRIPTION;
		}
	...
	public function setPicture($v)
	{
		...
		if ($this->picture !== $v) {
			$this->picture = $v;
			$this->modifiedColumns[] = TeamPeer::PICTURE;
		}
	...
	public function setExtra($v)
	{
		...
		if ($this->extra !== $v) {
			$this->extra = $v;
			$this->modifiedColumns[] = TeamPeer::EXTRA;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TeamPeer::INDEX)) $criteria->add(TeamPeer::INDEX, $this->index);
		if ($this->isColumnModified(TeamPeer::NAME)) $criteria->add(TeamPeer::NAME, $this->name);
		if ($this->isColumnModified(TeamPeer::SHORT_DESCRIPTION)) $criteria->add(TeamPeer::SHORT_DESCRIPTION, $this->short_description);
		if ($this->isColumnModified(TeamPeer::DESCRIPTION)) $criteria->add(TeamPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(TeamPeer::PICTURE)) $criteria->add(TeamPeer::PICTURE, $this->picture);
		if ($this->isColumnModified(TeamPeer::EXTRA)) $criteria->add(TeamPeer::EXTRA, $this->extra);
