...
abstract class BaseVideoPeer {
	...
	/** the column name for the DATE_CLOSED field */
	const DATE_CLOSED = 'video.DATE_CLOSED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Language', 'Date', 'DateClosed', 'Code', 'Name', 'Picture', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'language', 'date', 'dateClosed', 'code', 'name', 'picture', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LANGUAGE, self::DATE, self::DATE_CLOSED, self::CODE, self::NAME, self::PICTURE, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'language', 'date', 'date_closed', 'code', 'name', 'picture', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Language' => 1, 'Date' => 2, 'DateClosed' => 3, 'Code' => 4, 'Name' => 5, 'Picture' => 6, 'Description' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'language' => 1, 'date' => 2, 'dateClosed' => 3, 'code' => 4, 'name' => 5, 'picture' => 6, 'description' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LANGUAGE => 1, self::DATE => 2, self::DATE_CLOSED => 3, self::CODE => 4, self::NAME => 5, self::PICTURE => 6, self::DESCRIPTION => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'language' => 1, 'date' => 2, 'date_closed' => 3, 'code' => 4, 'name' => 5, 'picture' => 6, 'description' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new VideoMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VideoPeer::LANGUAGE);

		$criteria->addSelectColumn(VideoPeer::DATE);

		$criteria->addSelectColumn(VideoPeer::DATE_CLOSED);

		$criteria->addSelectColumn(VideoPeer::CODE);

		$criteria->addSelectColumn(VideoPeer::NAME);

		$criteria->addSelectColumn(VideoPeer::PICTURE);
	...
	{
		return VideoPeer::CLASS_DEFAULT;
	}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Video) {
	...
	public static function doValidate(Video $obj, $cols = null)
	{
		...
		if ($obj->isNew() || $obj->isColumnModified(VideoPeer::NAME))
			$columns[VideoPeer::NAME] = $obj->getName();
	...
	static function extList(Criteria $oCrit, $iStart=0, $iLimit=-1, $sSort=null, $sDir=null, PropelPDO $con=null )
	{
		...
		if(is_array($aData))
		{
			foreach($aData as $aRow)
			{
				...
				array_push($aResult,VideoPeer::extAddRow($aNewRow));
			}
		}
	...
	static function extConvertObject(Video $oVideo)
	{
		$aResult['Id'] = $oVideo->getId();
		$aResult['Language'] = $oVideo->getLanguage();
		$aResult['Date'] = $oVideo->getDate();
		$aResult['DateClosed'] = $oVideo->getDateClosed();
		$aResult['Code'] = $oVideo->getCode();
		$aResult['Name'] = $oVideo->getName();
		$aResult['Picture'] = $oVideo->getPicture();
		$aResult['Description'] = $oVideo->getDescription();
		return $aResult;
	}
} // BaseVideoPeer
...
//
// NOTE: This static code cannot call methods on the VideoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the VideoPeer class:
//
// Propel::getDatabaseMap(VideoPeer::DATABASE_NAME)->addTableBuilder(VideoPeer::TABLE_NAME, VideoPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseVideoPeer::DATABASE_NAME)->addTableBuilder(BaseVideoPeer::TABLE_NAME, BaseVideoPeer::getMapBuilder());
