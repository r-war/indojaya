...
abstract class BaseNews extends BaseObject  implements Persistent {
	 ...
	 * Note: this column has a database default value of: 'news'
	 * @var        string
	 */
	protected $type;
	...
	public function setLanguage($v)
	{
		...
		if ($this->language !== $v) {
			$this->language = $v;
			$this->modifiedColumns[] = NewsPeer::LANGUAGE;
		}
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = NewsPeer::CODE;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = NewsPeer::NAME;
		}
	...
	public function setPicture($v)
	{
		...
		if ($this->picture !== $v) {
			$this->picture = $v;
			$this->modifiedColumns[] = NewsPeer::PICTURE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = NewsPeer::DESCRIPTION;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(NewsPeer::TYPE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = NewsPeer::NUM_COLUMNS - NewsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::LANGUAGE)) $criteria->add(NewsPeer::LANGUAGE, $this->language);
		if ($this->isColumnModified(NewsPeer::TYPE)) $criteria->add(NewsPeer::TYPE, $this->type);
		if ($this->isColumnModified(NewsPeer::CODE)) $criteria->add(NewsPeer::CODE, $this->code);
		if ($this->isColumnModified(NewsPeer::DATE)) $criteria->add(NewsPeer::DATE, $this->date);
		if ($this->isColumnModified(NewsPeer::NAME)) $criteria->add(NewsPeer::NAME, $this->name);
		if ($this->isColumnModified(NewsPeer::PICTURE)) $criteria->add(NewsPeer::PICTURE, $this->picture);
		if ($this->isColumnModified(NewsPeer::DESCRIPTION)) $criteria->add(NewsPeer::DESCRIPTION, $this->description);
