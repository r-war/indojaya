...
abstract class BaseNewsPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Language', 'Type', 'Code', 'Date', 'Name', 'Picture', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'language', 'type', 'code', 'date', 'name', 'picture', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LANGUAGE, self::TYPE, self::CODE, self::DATE, self::NAME, self::PICTURE, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'language', 'type', 'code', 'date', 'name', 'picture', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Language' => 1, 'Type' => 2, 'Code' => 3, 'Date' => 4, 'Name' => 5, 'Picture' => 6, 'Description' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'language' => 1, 'type' => 2, 'code' => 3, 'date' => 4, 'name' => 5, 'picture' => 6, 'description' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LANGUAGE => 1, self::TYPE => 2, self::CODE => 3, self::DATE => 4, self::NAME => 5, self::PICTURE => 6, self::DESCRIPTION => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'language' => 1, 'type' => 2, 'code' => 3, 'date' => 4, 'name' => 5, 'picture' => 6, 'description' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
