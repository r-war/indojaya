...
abstract class BaseTeamPeer {
	...
	const SHORT_DESCRIPTION = 'team.SHORT_DESCRIPTION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Index', 'Name', 'ShortDescription', 'Description', 'Picture', 'Extra', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'index', 'name', 'shortDescription', 'description', 'picture', 'extra', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::INDEX, self::NAME, self::SHORT_DESCRIPTION, self::DESCRIPTION, self::PICTURE, self::EXTRA, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'index', 'name', 'short_description', 'description', 'picture', 'extra', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Index' => 1, 'Name' => 2, 'ShortDescription' => 3, 'Description' => 4, 'Picture' => 5, 'Extra' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'index' => 1, 'name' => 2, 'shortDescription' => 3, 'description' => 4, 'picture' => 5, 'extra' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::INDEX => 1, self::NAME => 2, self::SHORT_DESCRIPTION => 3, self::DESCRIPTION => 4, self::PICTURE => 5, self::EXTRA => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'index' => 1, 'name' => 2, 'short_description' => 3, 'description' => 4, 'picture' => 5, 'extra' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TeamPeer::INDEX);

		$criteria->addSelectColumn(TeamPeer::NAME);

		$criteria->addSelectColumn(TeamPeer::SHORT_DESCRIPTION);

		$criteria->addSelectColumn(TeamPeer::DESCRIPTION);

		$criteria->addSelectColumn(TeamPeer::PICTURE);

		$criteria->addSelectColumn(TeamPeer::EXTRA);
	...
	public static function doValidate(Team $obj, $cols = null)
	{
		...
		if ($obj->isNew() || $obj->isColumnModified(TeamPeer::NAME))
			$columns[TeamPeer::NAME] = $obj->getName();
	...
	static function extList(Criteria $oCrit, $iStart=0, $iLimit=-1, $sSort=null, $sDir=null, PropelPDO $con=null )
	{
		...
		if(is_array($aData))
		{
			foreach($aData as $aRow)
			{
				...
				array_push($aResult,TeamPeer::extAddRow($aNewRow));
			}
		}
	...
	static function extConvertObject(Team $oTeam)
	{
		$aResult['Id'] = $oTeam->getId();
		$aResult['Index'] = $oTeam->getIndex();
		$aResult['Name'] = $oTeam->getName();
		$aResult['ShortDescription'] = $oTeam->getShortDescription();
		$aResult['Description'] = $oTeam->getDescription();
		$aResult['Picture'] = $oTeam->getPicture();
		$aResult['Extra'] = $oTeam->getExtra();
		return $aResult;
	}
} // BaseTeamPeer
...
//
// NOTE: This static code cannot call methods on the TeamPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the TeamPeer class:
//
// Propel::getDatabaseMap(TeamPeer::DATABASE_NAME)->addTableBuilder(TeamPeer::TABLE_NAME, TeamPeer::getMapBuilder());
//
