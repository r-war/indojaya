...
abstract class BaseService extends BaseObject  implements Persistent {
	...
	public function setIndex($v)
	{
		...
		if ($this->index !== $v) {
			$this->index = $v;
			$this->modifiedColumns[] = ServicePeer::INDEX;
		}
	...
	public function setShortDescription($v)
	{
		...
		if ($this->short_description !== $v) {
			...
			$this->modifiedColumns[] = ServicePeer::SHORT_DESCRIPTION;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = ServicePeer::DESCRIPTION;
		}
	...
	public function setPicture($v)
	{
		...
		if ($this->picture !== $v) {
			$this->picture = $v;
			$this->modifiedColumns[] = ServicePeer::PICTURE;
		}
	...
	public function setExtra($v)
	{
		...
		if ($this->extra !== $v) {
			$this->extra = $v;
			$this->modifiedColumns[] = ServicePeer::EXTRA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->short_description = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->description = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->picture = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->extra = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = ServicePeer::NUM_COLUMNS - ServicePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ServicePeer::INDEX)) $criteria->add(ServicePeer::INDEX, $this->index);
		if ($this->isColumnModified(ServicePeer::NAME)) $criteria->add(ServicePeer::NAME, $this->name);
		if ($this->isColumnModified(ServicePeer::SHORT_DESCRIPTION)) $criteria->add(ServicePeer::SHORT_DESCRIPTION, $this->short_description);
		if ($this->isColumnModified(ServicePeer::DESCRIPTION)) $criteria->add(ServicePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(ServicePeer::PICTURE)) $criteria->add(ServicePeer::PICTURE, $this->picture);
		if ($this->isColumnModified(ServicePeer::EXTRA)) $criteria->add(ServicePeer::EXTRA, $this->extra);
