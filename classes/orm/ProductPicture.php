...
require 'orm/om/BaseProductPicture.php';


/**
 * Skeleton subclass for representing a row from the 'product_picture' table.
 *
 * 
 *
...
class ProductPicture extends BaseProductPicture {
	...
	/**
	 * Initializes internal state of ProductPicture object.
