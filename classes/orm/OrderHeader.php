...
require 'orm/om/BaseOrderHeader.php';


/**
 * Skeleton subclass for representing a row from the 'order_header' table.
 *
 * 
 *
 ...
 * @package    orm
 */
class OrderHeader extends BaseOrderHeader {

	/**
	 * Initializes internal state of OrderHeader object.
