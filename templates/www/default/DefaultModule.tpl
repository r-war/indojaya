     ...
     {*   <div class="row">
            <div class="col-md-6 col-sm-6 small-push-6 no-padding">
                <div class="four-boxes center-block text-blackish text-center padding-140px-tb wow fadeIn">
                    ...
                    <p class="text-center margin-20px-lr text-medium width-70 text-medium-gray main-font margin-30px-top xs-margin-20px-top">Creative Design, UI & UX, Content Management System, Ecommerce, Web & Mobile Application, Hosting & Email, Web Maintenance</p>
                    <a href="#portfolio" class="scroll btn btn-blackish font-weight-600 alt-font btn-rounded btn-large margin-20px-top">Browse Work</a>
            ...
            <div class="col-md-6 col-sm-6  small-push-6 no-padding">
                <div class="four-boxes center-block text-white text-center bg-sky-blue padding-140px-tb wow fadeIn">
                    ...
                    <h3 class="text-capitalize font-weight-100 alt-font no-margin-bottom">SEARCH ENGINE OPTIMIZATION (SEO)</h3>

                    <p class="text-center margin-20px-lr text-medium main-font margin-30px-top xs-margin-20px-top width-70 ">Hasil pencarian paling atas pada mesin pencari tanpa membayar apapun pada Google (BERGARANSI). Baik pencarian secara local, nasional, and global.</p>
                    <a href="#portfolio" class="scroll btn btn-white btn-rounded alt-font btn-large margin-20px-top">Print Media</a>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 small-push-6 no-padding">
                <div class="four-boxes center-block text-white bg-green padding-140px-tb text-center wow fadeIn">
                    ...
                    <p class="text-center margin-20px-lr main-font text-medium margin-30px-top xs-margin-20px-top width-70 ">Social Media Management, Social Media Campaign, Content Writing, Email Marketing</p>
                    <a href="#contactus" class="scroll btn btn-white btn-rounded btn-large alt-font margin-20px-top">Hire Us Now</a>
            ...
            <div class="col-md-6 col-sm-6 small-push-6 no-padding">
                <div class="four-boxes center-block text-blackish padding-140px-tb text-center wow fadeIn">
                    ...
                    <p class="text-center margin-20px-lr main-font text-medium text-medium-gray width-70 xs-margin-20px-top margin-30px-top ">Design untuk memaksimalkan brand identitas anda</p>
                    <a href="#team" class="scroll btn btn-blackish btn-rounded btn-large alt-font margin-20px-top">Meet Team</a>
    ...
    {*
      ...
      <section id="counters" class="demo-banner">
          ...
          <div class="container">
              ...
              <p class="text-extra-dark-gray text-medium xs-margin-20px-top no-margin">Curabitur mollis bibendum luctus duis suscipit vitae dui se bibendum.</p>
              </div>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="item pointer">
                        ...
                        <div class="team-box wow fadeInLeftBig team-ani" data-wow-delay="300ms">
                            ...
                            <div class="team-img">
                                <img src="{#IMAGE_PATH#}team-2.jpg" alt="img" />
                            </div>
...
<i class="fa fa-quote-right vertical-align-sub"></i></h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="wow fadeIn text-center">
                        ...
                        <p class="main-font text-medium-gray margin-80px-bottom text-medium xs-margin-20px-lr">Curabitur mollis bibendum luctus duis suscipit vitae dui se bibendum.</p>
                    </div>
                </div>
                <div class="row">
    ...
    <section class="bg-extreme-light-gray" id="packages">
        <div class="container">
            ...
            <p class="text-center main-font price-text">Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed suscipit.
                Vestibulum  auctor nunc vitae diam eleifend, in maximus metus sollicitudin. </p></div>
            <div class="row">
                <div class="col-sm-4 ">
                    <div class="bg-white pricing-item pointer startup text-center wow fadeIn">
                        ...
                        <p class="main-font font-weight-100 text-medium margin-10px-lr xs-margin-10px-lr text-medium-gray text-small">Click edit button to change this text, consectetur adipiscing elit.</p>
                        ...
                        <p class="main-font font-weight-100 text-small text-medium-gray margin-15px-bottom">Unlimited Bandwidth</p>
                        <p class="main-font font-weight-100 text-small text-medium-gray margin-15px-bottom">Email Accounts</p>
                        <p class="main-font font-weight-100 text-small text-medium-gray margin-15px-bottom">4 Free Forks Every Months</p>
                        <a href="#." class="btn btn-blackish alt-font font-weight-100 btn-rounded btn-medium margin-20px-top margin-40px-bottom">Buy Now</a>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="bg-white pricing-item standard pointer text-center wow fadeIn">
                        ...
                        <p class="main-font font-weight-100 text-medium xs-margin-10px-lr margin-10px-lr text-medium-gray text-small">Click edit button to change this text, consectetur adipiscing elit.</p>
                        <div class="price-tag clearfix">
                                    <span class="price">
                                        <span class="sign text-medium-gray">$</span>
                        ...
                        <p class="main-font font-weight-100 text-medium-gray text-small margin-15px-bottom">Unlimited Bandwidth</p>
                        <p class="main-font font-weight-100 text-medium-gray text-small margin-15px-bottom">Email Accounts</p>
                        <p class="main-font font-weight-100 text-medium-gray text-small margin-15px-bottom">4 Free Forks Every Months</p>
                        <a href="#." class="btn btn-blue alt-font font-weight-100 btn-rounded btn-medium margin-20px-top margin-40px-bottom">Buy Now</a>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class=" bg-white pricing-item premium pointer text-center fadeIn">
                        ...
                        <p class="main-font font-weight-100 text-medium-gray text-small margin-15px-bottom">Email Accounts</p>
                        <p class="main-font font-weight-100 text-medium-gray text-small margin-15px-bottom">4 Free Forks Every Months</p>
                        <a href="#." class="btn btn-green alt-font font-weight-100 btn-rounded btn-medium margin-20px-top margin-40px-bottom">Buy Now</a>
                    </div>
                </div>
            </div>
                    ...
                    <div id="testimonial-slider" class="owl-carousel owl-theme">
                        <div class="item pointer">
                            <div class="testimonial-wrapp">
                                ...
                                <div class="testimonial-photo"><img alt="" src="{#IMAGE_PATH#}testimonial-1.jpg"></div>
                        ...
                        <div class="item pointer">
                            <div class="testimonial-wrapp">
                                ...
                                <div class="testimonial-photo"><img alt="" src="{#IMAGE_PATH#}testimonial-3.jpg"></div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                      <div id="partners-slider" class="owl-carousel owl-client">
                        ...
                        <div class="item">
                            <div class="logo-item"> <img src="{#IMAGE_PATH#}client.png"></div>
                        </div>
                        {/foreach*}
                        <div class="item">
                            <div class="logo-item"><img src="{#IMAGE_PATH#}client.png"></div>
