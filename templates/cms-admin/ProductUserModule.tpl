...
<tr>
	...
	{include file='core/sortable.tpl' title='user' field='user.NAME' oSortable=$_sortable}
	{include file='core/sortable.tpl' title='product' field='product.NAME' oSortable=$_sortable}
	<th width="150px">{loc k=options}</th>
</tr>
</thead>
{foreach from=$aProductUser key=idx item=oObj}
