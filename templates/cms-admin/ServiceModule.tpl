...
<tr>
	...
	{*<th>{loc k=date}</th>*}
	{include file='core/sortable.tpl' title='index' field='SERVICE.INDEX' oSortable=$_sortable}
	{include file='core/sortable.tpl' title='name' field='SERVICE.NAME' oSortable=$_sortable}
	{*include file='core/sortable.tpl' title='url' field='Service.URL' oSortable=$_sortable*}
	{*include file='core/sortable.tpl' title='picture' field='page.PICTURE' oSortable=$_sortable*}
	<th width="200px">{loc k=options}</th>
</tr>
</thead>
{foreach from=$aService key=idx item=oObj}
