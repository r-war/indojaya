...
<tr>
	...
	{include file='core/sortable.tpl' title='#' field='product_picture.INDEX' oSortable=$_sortable}
	{include file='core/sortable.tpl' title='picture' field='product_picture.PICTURE' oSortable=$_sortable}
	{include file='core/sortable.tpl' title='name' field='product_picture.NAME' oSortable=$_sortable}
	<th width="230px">{loc k=options}</th>
</tr>
</thead>
{foreach from=$aProductPicture key=idx item=oObj}
